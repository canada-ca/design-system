...
<div class="home">
  <section>
    ...
    <div class="wb-frmvld" data-gc-analytics-chatformname="GC:Find the right template and design patterns for your web content" data-gc-analytics-collect='[{"value":"input[type=radio]","emptyField": "n/a"}]'>
      <form method="get">
        <!-- Wizard Q1 -->
        ...
        <div id="result14" class="hidden">
          <section class="panel panel-primary">
            <header class="panel-heading">
              <h2 class="panel-title">Search for your institution</h2>
            </header>
            <div class="panel-body">
              <p>Search for your organization in the list below to find out which profile to use.</p>
              <table class="wb-tables table table-striped table-hover small" data-wb-tables="{ &quot;ordering&quot; : false , &quot;paging&quot; : false }">
                <thead>
                  <tr class="active">
                    <th scope="col">Display name</th>
        ...
        <div id="result22" class="hidden">
          <section class="panel panel-primary">
            <header class="panel-heading">
              <h2 class="panel-title">Related pages</h2>
            </header>
            <div class="panel-body">
        ...
        <div id="result25" class="hidden">
          <section class="panel panel-primary">
            <header class="panel-heading">
              <h2 class="panel-title">Visual patterns</h2>
            </header>
            <div class="panel-body">
        ...
        <section class="panel panel-default">
          <header class="panel-heading">
            <h2 class="panel-title">Feedback, questions and suggestions</h2>
          </header>
          <div class="panel-body">
            ...
            <ul>
              ...
              <li>suggest a user-tested change to the templates and patterns</li>
              <li>contribute a missing pattern or template</li>
            </ul>
          </div>
        </section>
      </form>
