---
altLangPage: https://conception.canada.ca/modeles-recommandes/pages-comptes-rendu-rendement-services-institutionnels.html
date: '2018-12-19'
dateModified: '2026-06-15'
description: Use to present all service standards from an institution, as per the requirements in the Policy on Service.
service-digital-policy-url: https://www.tbs-sct.gc.ca/pol/doc-eng.aspx?id=32603
title: "Institutional service performance reporting pages template"
---

<div>
  <p>Institutional service performance reporting pages collect all service standards from an institution and provide annual performance reporting information, in support of the <a href="{{ page.service-digital-policy-url }}">Policy on Service and Digital</a>.</p>
    ...
    <div class="row">
      <div class="col-lg-6 pull-right">
        <figure class="mrgn-bttm-lg">
          ...
          <img alt="Template of institutional service performance reporting page showing sections that make up its structure. Read top to bottom and left to right. Specifications detailed below." class="full-width" src="../images/service-standards-page.png"/>
        </figure>
      </div>
      <div class="col-lg-6 pull-left">
        <section id="template-elements">
            ...
            <ul class="list-unstyled">
              <li id="element5">
                <details class="mrgn-bttm-sm">
                  <summary class="wb-toggle" data-toggle='{"print":"on"}'><strong>Content</strong></summary>
                  <ul>
                    <li>use this component when there is a large number of service standards being reported on</li>
                    <li>group subsections logically (for example, by service delivery channel, volume, or type of service)</li>
          ...
          <section>
            ...
            <p>Provides an overview of the institution’s service standards</p>
            <ul class="list-unstyled">
              <li id="element7">
                <details class="mrgn-bttm-sm">
                  <summary class="wb-toggle" data-toggle='{"print":"on"}'><strong>Content</strong></summary>
                  <ul>
                    <li>limit text to one or two paragraphs</li>
                  </ul>
                </details>
              </li>
              <li id="element8">
          ...
          <section>
            <h3>4: Service name and description</h3>
            <p>Provides an overview of the service delivered</p>
            <ul class="list-unstyled">
              <li id="element9">
                <details class="mrgn-bttm-sm">
                  <summary class="wb-toggle" data-toggle='{"print":"on"}'><strong>Content</strong></summary>
          ...
          <section>
            <h3>5: Service standards and performance information</h3>
            ...
            <ul class="list-unstyled">
              <li id="element11">
                <details class="mrgn-bttm-sm">
                  <summary class="wb-toggle" data-toggle='{"print":"on"}'><strong>Content</strong></summary>
                  <ul>
                    <li>includes service standards and performance information as per the <a href="{{ page.service-digital-policy-url }}">Policy on Service and Digital</a></li>
                    <li>content should align with the departmental service inventory</li>
                    <li>for each service standard being reported on, provide standards, targets and performance, as follows:
                      <ul>
                        <li>[Service]: name of the service to which the standard applies
                          <ul>
                            <li>Service description: brief plain-language description of the service</li>
                            <li>Our service standard: succinct statement of the standard</li>
                            <li>Our performance target: indicate the quantifiable target</li>
                            <li>Our service performance in [current fiscal year]: indicated the quantified performance</li>
                          </ul>
                        </li>
                      </ul>
                    </li>
          ...
          <section>
            <h3>6: Past service standards and performance</h3>
            ...
            <ul class="list-unstyled">
              <li id="element13">
                <details class="mrgn-bttm-sm">
                  <summary class="wb-toggle" data-toggle='{"print":"on"}'><strong>Content</strong></summary>
                  <ul>
                    <li>presents previous years’ performance results (either linked or included directly on the page)</li>
  ...
  <section>
    ...
    <figure class="mrgn-bttm-lg">
      ...
      <details>
        ...
        <p>People can access the institutional service performance reporting pages from institutional landing pages.</p>
      </details>
    </figure>
  </section>
  <section>
    ...
    <dl class="dl-horizontal">
      ...
      <dd>Updated guidance to remove institutional byline pattern, which is being decommissioned.</dd>
    </dl>
  </section>
</div>
