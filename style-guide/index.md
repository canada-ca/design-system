    ...
    <section>
      ...
      <section>
        ...
        <figure class="mrgn-bttm-lg">
          ...
          <img alt="A web page containing a heading with a question mark. Text version below:" class="img-responsive center-block" id="fig3" src="{{ site.url }}/style-guide/images/csc-grc-fig-03-eng.jpg">
          <details class="brdr-tp brdr-rght brdr-bttm brdr-lft">
...
<section>
  ...
  <section>
    ...
    <figure class="mrgn-bttm-lg">
      ...
      <img alt="A balanced scorecard showing how business activities align with an organization's vision and strategy to monitor key performance indicators. Text version below. " class="img-responsive center-block" src="{{ site.url }}/style-guide/images/csc-grc-fig-01b-eng.jpg">
  ...
  <section>
    ...
    <figure class="mrgn-bttm-lg">
      ...
      <img alt="Comparison of the ratio of women and men in the civil service between 1983 and 2010. Text version below." class="img-responsive center-block" src="{{ site.url }}/style-guide/images/csc-grc-fig-02b-eng.jpg">
