...
Both Lato and Noto Sans support a wide variety of languages and non-latin characters. However, Noto Sans has a larger range of additional font families than can be added by developers to support specific alternative language content. The Noto Sans Canadian Aboriginal font-family is included by default in the typography of Canada.ca.
