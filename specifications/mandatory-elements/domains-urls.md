...
description: The Canada.ca domain is the primary domain for the Government of Canada's public-facing web presence.
...
<p><b>Note</b>: Sub-domain requests are reviewed by Service Canada. Your web account manager can submit new Canada.ca sub-domains and change requests to the Principal Publisher using the <a href="https://requestform.portal.gc.ca/tickets.html">Request form for Canada.ca (internal to government)</a>.</p>
</section>
<section id="du2">
...
<ul>
    ...
    <li>use only US-ASCII (7-bit version of ASCII) characters (for example, use “meteo” instead of “météo”)
      <ul>
        <li>exception: diacritic marks (accented letters) are allowed in vanity URLs</li>
      </ul>
    </li>
