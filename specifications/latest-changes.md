...
<div id="expand-collapse">
  ...
  <details>
    ...
    <p>Added an alert to the basic page layout to indicate that it is being decommissioned and to instead follow the GC Design System <a href="https://design-system.alpha.canada.ca/en/page-templates/basic/">Basic page template</a>.</p>
  </details>
  <details>
  ...
  <details>
    ...
    <p>Updated the <a href="{{ site.url }}/common-design-patterns/services-information.html">services and information pattern</a> to include guidance on using section headings, grey banding and/or single column layouts</p>
  </details>
  <details>
  ...
  <details>
    ...
    <p>We made a change to the <a href="{{ site.url }}/common-design-patterns/site-footer.html">Site footer</a> documentation to make the Report a problem pattern optional.</p>
  </details>
  <details>
