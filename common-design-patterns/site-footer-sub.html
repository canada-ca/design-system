...
<title>Sub-footer band - Canada.ca design system - Canada.ca</title>
<meta content="width=device-width,initial-scale=1" name="viewport">
<meta name="description" content="This is a mandatory element of the global (site-wide) footer." />
<meta name="author" content="Treasury Board Secretariat of Canada" />
<meta name="dcterms.title" content="Sub-footer band" />
<meta name="dcterms.description" content="This is a mandatory element of the global (site-wide) footer." />
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="list-inline margin-bottom-none">
            <li><a lang="fr" href="https://conception.canada.ca/configurations-conception-communes/pied-page-sous.html">Français</a></li>
          </ul>
        </div>
      </div>
    </section>
...
<main role="main" property="mainContentOfPage" class="container">
  <h1 property="name" id="wb-cont" dir="ltr"><span class="stacked"><span>Global footer: Sub-footer band</span>: <span>Canada.ca design system</span></span></h1>
