...
---
		<title>Research summary: Recalls and safety alerts search optimization, Round 2 - Canada.ca</title>
	...
	<body vocab="http://schema.org/" typeof="WebPage">
		...
		<script type="text/javascript">
			...
			defTop.outerHTML = wet.builder.top({
				lngLinks: [{
					language: "fr",
					href: "https://blogue.canada.ca/resumes-recherche/rappels-securite-resume-recherche.html",
					text: "Français"
				}],
				breadcrumbs: [{
					title: "Home",
	...
	<h1>Research summary: Recalls and safety alerts search optimization, Round 2</h1>
...
<p>Our experience with the RSAMS project reinforced our understanding of the complexity of delivering effective specialized search. The key recommendations, summarized here, apply to any specialized search implementation.</p>
	...
	<p>For this project, we had a static dataset. That meant we could make manual additions and deletions to prepare a single, search-specific data source for indexing. Changes made to the data included:
<ul>
...
<p>An effective search solution requires dedicated resources. It needs to involve multiple skill sets in its design and maintenance. This should include subject matter experts, information architects, content designers, developers, data and network specialists, search analysts, and user researchers.</p>
	...
	<p>To quote our search expert: <blockquote>“Search is hard. Good search is harder.”</blockquote> </p>
