...
<div class="row">
  <div class="mrgn-tp-lg mrgn-bttm-lg col-md-8">
    <figure class="gc-complex-img" role="group"> <img alt="A long description can be found after the image." src="/research-summaries/images/rs-wafingding-footer-en.png" class="img-responsive" />
      <figcaption>
        <details>
...
<div class="row">
  <div class="mrgn-tp-lg mrgn-bttm-lg col-md-8">
    <figure class="gc-complex-img" role="group"> <img alt="A long description can be found after the image." src="/research-summaries/images/rs-wayfinding-theme-02-en.png" class="img-responsive" />
      <figcaption>
        <details>
...
<div class="row">
  <div class="mrgn-tp-lg mrgn-bttm-lg col-md-8">
    <figure class="gc-complex-img" role="group"> <img alt="A long description can be found after the image." src="/research-summaries/images/rs-wayfinding-sign-in-01-en.png" class="img-responsive" />
      <figcaption>
        <details>
