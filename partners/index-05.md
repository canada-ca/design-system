  ...
  <li>
    <div class="row bg-grey">
      <div class="col-md-12 mrgn-bttm-lg">
        ...
        <div class="mrgn-tp-lg text-center"><a href="project-01.html" class="btn btn-lg btn-default">Orientation and wayfinding project</a></div>
      </div>
    </div>
  </li>
  <li>
    <div class="row">
      <div class="col-md-12 mrgn-bttm-lg">
        ...
        <div class="mrgn-tp-lg text-center"><a href="project-02.html" class="btn btn-lg btn-default">Medical devices project</a></div>
      </div>
    </div>
  </li>
  <li>
